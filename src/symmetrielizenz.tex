...
\usepackage[a4paper, total={5.5in, 10in}, top=0.85in]{geometry}
...
% \title{\vspace{-1.1cm}\raisebox{-4mm}{\includegraphics[width=2.0cm]{img/s.pdf}}\ \ Symmetrielizenz / Symmetry Licence\ \ EU-v0.1}
\author{}
\date{}
...
\begingroup
  \centering
  \LARGE \raisebox{-4mm}{\includegraphics[width=2.0cm]{img/s.pdf}}\ \ Symmetrielizenz / Symmetry Licence\ \ EU-v0.1\\[3em]
\endgroup
...
\begin{center}\includegraphics[width=0.7cm]{img/s.pdf}\end{center}
